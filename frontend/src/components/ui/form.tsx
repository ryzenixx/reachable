...
function FormLabel({ className, ...props }: React.ComponentProps<"label">): React.JSX.Element {
  ...
  return (
    <label
      ...
      className={cn("text-[13px] font-medium text-neutral-700 leading-none", error && "text-red-600", className)}
      htmlFor={formItemId}
      {...props}
    />
  );
...
function FormDescription({ className, ...props }: React.ComponentProps<"p">): React.JSX.Element {
  ...
  return (
    <p
      ...
      className={cn("text-[12px] text-neutral-400", className)}
      {...props}
    />
  );
}
...
function FormMessage({ className, children, ...props }: React.ComponentProps<"p">): React.JSX.Element | null {
  ...
  return (
    <p
      ...
      id={formMessageId}
      className={cn("text-[12px] font-medium text-red-600", className)}
      {...props}
    >
      {body}
    </p>
